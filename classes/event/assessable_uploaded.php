...
/**
 * The assignsubmission_timedonline assessable uploaded event.
 *
...
/**
 * The assignsubmission_timed online assessable uploaded event class.
 *
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has saved a timed online submission with id '$this->objectid' " .
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'assignsubmission_timedonline');
    }
