...
class restore_assignsubmission_timedonline_subplugin extends restore_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/submission_timedonline');
    ...
    /**
     * Processes one assignsubmission_timedonline element
     *
     * @param mixed $data
     */
    public function process_assignsubmission_timedonline_submission($data) {
        global $DB;
        ...
        $this->add_related_files('assignsubmission_timedonline', 'submissions_timedonline', 'submission', null, $oldsubmissionid);
    }
